    ...
    <div className="max-w-2xl mx-auto mt-10 p-6">
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="bg-blue-50 p-4 rounded-xl mb-8">
          <div className="flex items-center gap-2 text-red-500 mb-2">
            ...
            <p className="font-medium">
              Printing & delivery takes 6 to 10 days, so please order
              accordingly
            </p>
          </div>
          <p className="text-center text-gray-600">
            Once you order, you can still make changes for 12 hours.
          </p>
        </div>
        ...
        <div className="flex justify-center gap-6 mb-8">
          ...
          />
          <img
            src="https://www.apple.com/v/apple-pay/i/images/overview/og_image.png?202311160446"
            alt="Apple Pay"
            className="h-8"
          />
          <img
